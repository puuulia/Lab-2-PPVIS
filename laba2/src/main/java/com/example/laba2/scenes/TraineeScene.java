...
public class TraineeScene extends Scene {
    ...
    private final Button correctPlantButton = new Button("ИНФОРМАЦИЯ О РАСТЕНИИ");
    private final Button correctRecommendButton = new Button("ИНФОРМАЦИЯ ОБ УЧАСТКЕ");
    private final Button correctTestsButton = new Button("ОБУЧЕНИЕ");
